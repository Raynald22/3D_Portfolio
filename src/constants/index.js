...
const experiences = [
  {
    title: "Web Developer",
    company_name: "Ogya Tekno Nusantara",
    icon: ogya,
    iconBg: "#383E56",
    date: "Jul 2021 - Present",
    points: [
      "Developing and maintaining web applications using Angular and Java.",
  ...
  },
  {
    ...
    points: [
      "Developing and maintaining web applications using Ruby and other related technologies.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
...
const projects = [
  ...
  },
  {
    ...
    image: sakti,
    source_code_link: "https://sakti.kemenkeu.go.id/",
  },
  {
    name: "Trip Guide",
    description:
